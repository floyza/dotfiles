...
;;
(defgroup my-gruvbox-theme nil
  "Options for my-gruvbox."
  :group 'doom-themes)

(defcustom my-gruvbox-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'my-gruvbox-theme
  :type 'boolean)

(defcustom my-gruvbox-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'my-gruvbox-theme
  :type '(choice integer boolean))

(defcustom my-gruvbox-dark-variant nil
...
;;
(def-doom-theme my-gruvbox
  "Dark theme with pastel 'retro groove' colors."

  ;; name        gui       256       16
  ((bg
    (cond ((equal my-gruvbox-dark-variant "hard") '("#1d2021" "#1e1e1e" nil))   ; bg0_h
          ((equal my-gruvbox-dark-variant "soft") '("#32302f" "#323232" nil))   ; bg0_s
          (t                                        '("#282828" "#282828" nil)))) ; bg0
   (bg-alt
    (cond ((equal my-gruvbox-dark-variant "hard") '("#0d1011" "black" nil))     ; (self-defined)
          ((equal my-gruvbox-dark-variant "soft") '("#282828" "#282828" nil))   ; bg0
   ...
   (selection      bg-alt2)
   (builtin        orange)
   (comments       (if my-gruvbox-brighter-comments magenta grey))
   (doc-comments   (if my-gruvbox-brighter-comments (doom-lighten magenta 0.2) (doom-lighten fg-alt 0.25)))
   (constants      violet)
   (functions      green)
   (keywords       red)
   (methods        green)
   ...
   ;; custom categories
   (-modeline-pad
    (when my-gruvbox-padded-modeline
      (if (integerp my-gruvbox-padded-modeline)
          my-gruvbox-padded-modeline
        4)))
   (modeline-bg bg-alt2)
  ...
  (((font-lock-comment-face &override) :slant 'italic)
   ;; ((font-lock-type-face &override) :slant 'italic) ; <- this messes up the font when enabled
