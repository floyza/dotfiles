{ stdenv, lib, fetchFromGitHub, fetchgit, python3, gn, ninja, fontconfig, expat
, icu58, libglvnd, libjpeg, libpng, libwebp, zlib, mesa, libX11 }:
...
in stdenv.mkDerivation {
  ...
  src = fetchFromGitHub {
    ...
    rev =
      "861e4743af6d9bf6077ae6dda7274e5a136ee4e2"; # TODO: Remove the gnOld override
    sha256 = "sha256-IlZbalmHl549uDUfPG8hlzub8TLWhG0EsV6HVAPdsl0=";
  };

  nativeBuildInputs = [ python3 gnOld ninja ];
